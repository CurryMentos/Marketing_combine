...
import com.bestpay.marketing.config.api.activity.models.response.CouponInfoApplyRespDTO;
...
public class QueryCoupon {
    ...
    public static void queryCoupon() throws Exception {
        ...
        Result<CouponInfoApplyRespDTO> result = equityApplyService.queryCoupon( equityQueryReqDTO );
        ...
        if (result.getResult() != null) {
            ...
            System.out.println( "产品码" + result.getResult().getProductCode() );
            ...
            System.out.println( "单张最小面额" + result.getResult().getMinDenomination() );
            System.out.println( "单张最大面额" + result.getResult().getMaxDenomination() );
            System.out.println( "消费限额(最小/门槛)" + result.getResult().getLowerLimit() );
