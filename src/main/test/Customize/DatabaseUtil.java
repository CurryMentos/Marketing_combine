...
public class DatabaseUtil {
    ...
    private static String AccountUrl = "jdbc:oracle:thin:@172.17.45.5:1521/test30";
    private static String AccountUserName = "ACCOUNT";
    private static String AccountPassWord = "bestpay";

    //46环境oracle数据库Marketing库
    private static String MarketingUrl = "jdbc:oracle:thin:@172.17.45.6:1521/test20";
    private static String MarketingUserName = "marketing";
    private static String MarketingPassWord = "bestpay";

    //46环境mysql数据库marketing_portal库
    private static String PortalUrl = "jdbc:mysql://172.17.46.5:3306/marketing_portal";
    ...
    private static String LedgerUrl = "jdbc:mysql://172.17.46.5:3306/marketing_ledger";
    ...
    private static String LimitUrl = "jdbc:mysql://172.17.46.5:3306/marketing_limit";
    ...
    private static String ActivityUrl = "jdbc:mysql://172.17.46.5:3306/marketing_activity_operation";
    ...
    private static String EncourageUrl = "jdbc:mysql://172.17.46.5:3306/marketing_encourage";
    ...
    private static String RuleUrl = "jdbc:mysql://172.17.46.5:3306/marketing_rule";
    private static String RuleUserName = "mktrule_app";
    private static String RulePassWord = "mktrule_app78@78M";

    //沙箱oracle数据库
    /*private static String AccountUrl = "jdbc:oracle:thin:@172.17.164.30:1521/test30";
    private static String AccountUserName = "ACCOUNT_APP";
    private static String AccountPassWord = "bestpay";*/

    //沙箱环境mysql数据库marketing_encourage库
//    private static String EncourageUrl = "jdbc:mysql://172.17.164.4:3306/marketing_encourage";
//    private static String EncourageUserName = "u_encourage";
//    private static String EncouragePassWord = "u_encourage78@78M";
    ...
    //连接客户体系数据库
    public static Connection connectToMarketing() {
        Connection connection = null;
        try {
            connection = DriverManager.getConnection(MarketingUrl, MarketingUserName, MarketingPassWord);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return connection;
